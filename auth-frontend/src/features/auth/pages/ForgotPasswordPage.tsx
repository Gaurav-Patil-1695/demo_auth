  ...
  return (
    <>
      ...
      <div className="forgot-page">
        <div className="forgot-page__branding" aria-label="auth-starter branding">
          <div className="forgot-page__logo">auth-starter</div>
          <div className="forgot-page__tagline">Secure authentication, out of the box.</div>
        </div>
